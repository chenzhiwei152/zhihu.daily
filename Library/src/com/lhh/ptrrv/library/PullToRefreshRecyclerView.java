...
public class PullToRefreshRecyclerView extends SwipeRefreshLayout implements PrvInterface {
    ...
    private final String TAG = "PullToRefreshRecyclerView";
    ...
    public void setScrollListener(OnScrollListener scrollListener) {
        mOnScrollLinstener = scrollListener;
    }
    ...
    public void addHeaderView(View view) {
        ...
        mHeader.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Log.e("PullToRefresh", "mHeader高度：" + mHeader.getMeasuredHeight());
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (mHeader != null) {
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.HONEYCOMB) {
                    Log.e("PullToRefresh", "mCurScroll：" + mCurScroll);
