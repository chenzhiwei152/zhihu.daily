...
public class AsyncHttpClient {
     ...
     * Default setting is VERBOSE log level.
     *
     * @param logLevel int log level, either from LogInterface interface or from {@link Log}
     */
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(String url, RequestParams params,String contenType, ResponseHandlerInterface responseHandler) {
        return post(null, url, params,contenType,responseHandler);
    }
    /**
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(Context context, String url, RequestParams params,String contentType,  ResponseHandlerInterface responseHandler) {
        return post(context, url, paramsToEntity(params, responseHandler), contentType, responseHandler);
    }
    /**
     * Perform a HTTP POST request and track the Android Context which initiated the request.
     *
    ...
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context) {
        if (uriRequest == null) {
            ...
            Log.e("","url= " + uriRequest.getURI());
            for (Header h:uriRequest.getAllHeaders()) {
                Log.e("","header= "+"header-"+h.getName()+"= "+h.getValue());
            }
        }
        ...
        log.e(LOG_TAG, "posturl==" + uriRequest.getURI().toString());
