...
//            InputStream is = PinyinResource.class.getResourceAsStream(resourceName);
            InputStream is = AppContext.getInstance().getResources().getAssets().open(resourceName);
